...
function prepare_bam {
  ...
  samtools merge -c -p -f -O BAM ${out_bam} tmp/nuclear_subsampled.bam tmp/chrM_with_deletion_subsampled.bam
...
prepare_bam 11 10 map-hifi data/HG002_haplotagged.bam testdata/HG002_PacBio_Revio_copy.bam
